...
import { ArrowLeft, ShieldAlert, GlobeLock, Code2, CheckCircle2, FileJson } from 'lucide-react';

export default async function APISolutionDetail({ params }: { params: Promise<{ id: string }> }) {
        ...
        <main className="min-h-screen bg-white">
            ...
            <section className="relative h-[400px] flex items-center justify-center overflow-hidden bg-[#1a237e]">
                ...
                <div className="relative z-10 container mx-auto px-6 text-center mt-20">
                    ...
                    <p className="text-indigo-200 print:text-black text-lg font-medium">{solution.subtitle}</p>
                </div>
            </section>
            ...
            <section className="py-20 bg-white">
                <div className="container mx-auto px-6 max-w-5xl">
                    ...
                    {/* Back Button */}
                    <div className="mb-12">
                        <Link href="/solutions/api" className="inline-flex items-center text-slate-500 hover:text-indigo-600 font-bold transition-colors">
                    ...
                    <div className="flex flex-col md:flex-row gap-12">
                        ...
                        <div className="w-full md:w-1/4">
                            <div className="sticky top-32 flex flex-col items-center p-8 bg-slate-50 rounded-3xl border border-slate-100 text-center">
                                <div className="w-24 h-24 rounded-full bg-white border-2 border-slate-100 flex items-center justify-center text-indigo-600 mb-6 shadow-sm">
                                    {React.cloneElement(solution.icon, { className: "w-10 h-10" })}
                                </div>
                                ...
                                <Link href="/support" className="w-full py-3 bg-indigo-600 text-white rounded-xl font-bold shadow-lg shadow-indigo-500/20 hover:bg-indigo-700 transition-all text-sm">
                                    도입 문의하기
                                </Link>
                            </div>
                        </div>
                            ...
                            <div className="prose prose-lg max-w-none">
                                ...
                                <div className="grid grid-cols-1 gap-4 mb-12">
                                    {solution.features.map((feature, idx) => (
                                        <div key={idx} className="flex items-start gap-4 p-5 rounded-2xl bg-slate-50 border border-slate-100 hover:border-indigo-200 transition-colors">
                                ...
                                <h2 className="text-2xl font-bold text-slate-900 mb-6 flex items-center gap-2">
                                    <GlobeLock className="w-5 h-5 text-indigo-500" />
                                    기술 사양 및 인증
                                </h2>
